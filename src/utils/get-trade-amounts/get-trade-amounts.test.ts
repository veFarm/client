...
const t1ProtocolFee: BigNumber = ((t1WithdrawAmount.minus(t1TxFee)).times(3)).div(1000)
const t1DexFee: BigNumber = ((t1WithdrawAmount.minus(t1TxFee).minus(t1ProtocolFee)).times(3)).div(1000)
